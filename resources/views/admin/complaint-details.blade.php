...
<head>
    ...
    <style>
        ...
        .form-control { width: 100%; padding: 10px 12px; border: 1px solid #d1d5db; border-radius: 6px; font-family: inherit; font-size: 0.95rem; box-sizing: border-box; }
        .form-control:focus { outline: none; border-color: #2563eb; box-shadow: 0 0 0 3px rgba(37, 99, 235, 0.1); }
        .btn-primary { background: #2563eb; color: white; border: none; padding: 10px 20px; border-radius: 6px; font-weight: 600; cursor: pointer; transition: 0.2s; }
    ...
    <div class="dashboard-layout">
        ...
        <div style="display: flex; flex-direction: column; flex-grow: 1;">
            ...
            <main class="main-content">
                @if(session('msg'))
                    <div style="background: rgba(16, 185, 129, 0.1); color: #10B981; padding: 16px; border-radius: 8px; margin-bottom: 24px; font-weight: 500; display: flex; align-items: center;">
                ...
                <div class="page-header">
                    <div>
                        ...
                        <p class="page-subtitle">Filed by <strong>{{ $complaint->name }}</strong> on {{ date('F j, Y, g:i a', strtotime($complaint->regDate)) }}</p>
                    </div>
                    <a href="/admin/notprocess-complaint" class="btn-outline">
                        <i class="fa fa-arrow-left" style="margin-right: 8px;"></i> Back to List
                    </a>
                </div>
                ...
                <div class="content-layout">
                    ...
                    <div class="main-panel">
                            ...
                            <div class="card-body">
                                @if(count($remarkHistory) == 0)
                                    <div class="empty-state">
                                        ...
                                        <p>No administrative remarks have been posted yet. This complaint needs to be processed.</p>
                                    </div>
                                @else
                                    <div class="timeline">
                        ...
                        <div class="saas-card" style="border: 1px solid #2563eb;">
                            <div class="card-header" style="background: #eff6ff; border-bottom: 1px solid #bfdbfe;">
                                <h2 class="card-title" style="color: #1e40af;"><i class="fa fa-edit" style="margin-right: 8px;"></i> Update Case Status</h2>
                            </div>
                            <div class="card-body">
                                <form action="/admin/complaint-details/{{ $complaint->complaintNumber }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <label class="form-label">Administrative Remark</label>
                                        <textarea name="remark" class="form-control" rows="4" placeholder="Enter details of action taken..." required></textarea>
                                    </div>
                                    <button type="submit" class="btn-primary" style="width: 100%;"><i class="fa fa-save" style="margin-right: 8px;"></i> Submit Update</button>
                                </form>
                            </div>
                        </div>
                        @else
                        <div class="saas-card" style="background: #f0fdf4; border: 1px solid #bbf7d0;">
                            <div class="card-body" style="text-align: center; color: #166534;">
                                <i class="fa fa-check-circle" style="font-size: 3rem; margin-bottom: 16px;"></i>
                                <h3 style="margin: 0 0 8px 0;">Case Closed</h3>
                                <p style="margin: 0;">This complaint has been fully resolved and closed. No further updates can be made.</p>
                            </div>
                        </div>
                        @endif
                    ...
                    <div class="side-panel">
                        <div class="saas-card">
                            ...
                            <div class="card-body">
                                <ul class="meta-list">
                                    <li>
                                        <span class="meta-label">Complainant</span>
                                        <span class="meta-value">{{ $complaint->name }}</span>
                                    </li>
                                    <li>
                                        <span class="meta-label">Email</span>
                                        <span class="meta-value" style="word-break: break-all;">{{ $complaint->email }}</span>
                                    </li>
                                    <li>
                                        <span class="meta-label">Contact</span>
                                        <span class="meta-value">{{ $complaint->contact }}</span>
                                    </li>
                                    <li>
