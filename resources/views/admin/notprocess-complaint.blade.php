        ...
        <div style="display: flex; flex-direction: column; flex-grow: 1;">
            ...
            <main class="main-content">
                <div style="margin-bottom: 24px;">
                    <h2><i class="fa fa-file-signature" style="margin-right: 10px; color: var(--primary);"></i> Not Processed Complaints</h2>
                </div>
                    ...
                    <table>
                        ...
                        @foreach($complaints as $row)                                  
                            <tr>
                                ...
                                <td>
                                    <span class="badge" style="background: rgba(239, 68, 68, 0.1); color: #EF4444;">Not Processed yet</span>
                                </td>
                                <td>
