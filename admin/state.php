        ...
        <div style="display: flex; flex-direction: column; flex-grow: 1;">
            ...
            <main class="main-content">
                <div style="margin-bottom: 24px;">
                    <h2><i class="fa fa-map-marker-alt" style="margin-right: 10px; color: var(--primary);"></i> State Management</h2>
                </div>
                ...
                <div class="card" style="margin-bottom: 30px;">
                    ...
                    <form name="Category" method="post" style="max-width: 600px;">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="description" rows="5" placeholder="Enter state description"></textarea>
                        </div>
                    ...
                    <table>
                        ...
                        ?>                                  
                            <tr>
                                ...
                                <td style="font-weight: 600; color: var(--text-main);"><?php echo htmlentities($row['stateName']);?></td>
                                <td><?php echo htmlentities($row['stateDescription']);?></td>
                                <td style="color: var(--text-muted);"><?php echo htmlentities($row['postingDate']);?></td>
                                <td style="color: var(--text-muted);"><?php echo htmlentities($row['updationDate']);?></td>
                                <td>
                                    <a href="edit-state.php?id=<?php echo $row['id']?>" style="color: var(--info); margin-right: 12px;"><i class="fa fa-edit"></i></a>
                                    <a href="state.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')" style="color: var(--error);"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php $cnt=$cnt+1; } ?>
                        </tbody>
