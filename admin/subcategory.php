        ...
        <div style="display: flex; flex-direction: column; flex-grow: 1;">
            ...
            <main class="main-content">
                <div style="margin-bottom: 24px;">
                    <h2><i class="fa fa-folder-open" style="margin-right: 10px; color: var(--primary);"></i> Sub Category Management</h2>
                </div>
                ...
                <div class="card" style="margin-bottom: 30px;">
                    <h3 style="margin-bottom: 20px; font-size: 1.25rem;">Create SubCategory</h3>
                    <form name="subcategory" method="post" style="max-width: 600px;">
                        ...
                        <button type="submit" name="submit" class="btn btn-primary">Create SubCategory</button>
                    </form>
                </div>
                    ...
                    <table>
                        ...
                        ?>                                  
                            <tr>
                                ...
                                <td>
                                    <a href="edit-subcategory.php?id=<?php echo $row['id']?>" style="color: var(--info); margin-right: 12px;"><i class="fa fa-edit"></i></a>
                                    <a href="subcategory.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')" style="color: var(--error);"><i class="fa fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php $cnt=$cnt+1; } ?>
                        </tbody>
